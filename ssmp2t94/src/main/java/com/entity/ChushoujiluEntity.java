...
public class ChushoujiluEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChushoujiluEntity() {
		
	}
	
	public ChushoujiluEntity(T t) {
		try {
	 ...
	 * 设置：出售单号
	 */
	public void setChushoudanhao(String chushoudanhao) {
		this.chushoudanhao = chushoudanhao;
	}
	/**
	 * 获取：出售单号
	 */
	public String getChushoudanhao() {
		return chushoudanhao;
	}
	/**
	 * 设置：商品编号
	 */
