...
public class XinxifabuModel  implements Serializable {
	...
	private String chushoushangpinmingcheng;
	...
	public void setChushoushangpinmingcheng(String chushoushangpinmingcheng) {
		this.chushoushangpinmingcheng = chushoushangpinmingcheng;
	}
	
	/**
	 * 获取：出售商品名称
	 */
	public String getChushoushangpinmingcheng() {
		return chushoushangpinmingcheng;
	}
