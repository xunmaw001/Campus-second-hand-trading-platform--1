<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="购买单号" prop="goumaidanhao">
            <el-input v-model="ruleForm.goumaidanhao" 
                placeholder="购买单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goumaidanhao" label="购买单号" prop="goumaidanhao">
              <el-input v-model="ruleForm.goumaidanhao" 
                placeholder="购买单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出售单价" prop="chushoudanjia">
          <el-input v-model="ruleForm.chushoudanjia" 
              placeholder="出售单价" clearable  :readonly="ro.chushoudanjia"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买总价" prop="goumaizongjia">
            <el-input v-model="goumaizongjia"
                placeholder="购买总价" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goumaizongjia" label="购买总价" prop="goumaizongjia">
              <el-input v-model="ruleForm.goumaizongjia" 
                placeholder="购买总价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  data() {
	...
	userid : false,
      ...
      rules: {
          goumaidanhao: [
                { required: true, message: '购买单号不能为空', trigger: 'blur' },
          ],
          shangpinbianhao: [
    ...
    shangpinbianhaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.chushoudanjia){
                this.ruleForm.chushoudanjia = data.data.chushoudanjia
              }
        } else {
          this.$message.error(data.msg);
        }
