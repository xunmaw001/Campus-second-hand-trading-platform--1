    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="卖家账号" prop="maijiazhanghao">
          <el-select v-model="ruleForm.maijiazhanghao" placeholder="请选择卖家账号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="卖家姓名" prop="maijiaxingming">
          <el-select v-model="ruleForm.maijiaxingming" placeholder="请选择卖家姓名">
            <el-option
                v-for="(item,index) in maijiaxingmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
