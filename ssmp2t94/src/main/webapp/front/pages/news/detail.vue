<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"rgba(68, 68, 68, 1)","textAlign":"center"}'>标题：</view>
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"center","fontSize":"28rpx"}'>{{detail.title}}</view>
				</view>
