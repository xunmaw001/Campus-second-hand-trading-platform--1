	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"center","fontSize":"28rpx"}'>{{detail.xingming}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"100rpx"}'>
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"rgba(68, 68, 68, 1)","textAlign":"center"}'>性别：</view>
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"center","fontSize":"28rpx"}'>{{detail.xingbie}}</view>
				</view>
                				                								                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"100rpx"}'>
